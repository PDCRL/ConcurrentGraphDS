 ...
 *
 * Description:
 *   Fine-Grained Vertex Lock-based implementation of a concurrent directed graph (represented as adjacency list) with deletion of incoming edges of deleted vertices
 *
 * Copyright (c) 2017.
 *
 * one_vlock_remove_ie.cpp is part of ConcurrentGraphDS
*/


#include "one_vlock_remove_ie.h"
