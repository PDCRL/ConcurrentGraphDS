 ...
 *
 * Description:
 *   Fine-Grained Vertex + Edge Lock-based implementation of a concurrent directed graph (represented as adjacency list) without deletion of incoming edges of deleted vertices
 *
 * Copyright (c) 2017.
 *
 * velock_not_remove_ie.cpp is part of ConcurrentGraphDS
*/


#include "velock_not_remove_ie.h"
