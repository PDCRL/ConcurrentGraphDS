/*
 * File:
 *   two_vlock_not_remove_ie_reach.cpp
 *
 * Author(s):
 ...
 *
 * Description:
 *   Fine-Grained Vertex Lock-based implementation of a concurrent directed graph (represented as adjacency list) without deletion of incoming edges of deleted vertices, with cycle detect as reach method
 *
 * Copyright (c) 2017.
 *
 * two_vlock_not_remove_ie_reach.cpp is part of ConcurrentGraphDS
*/


#include "two_vlock_not_remove_ie_reach.h"
...
void* pthread_call(void *t)
{
	...
	int other, res;
 	...
 	int numOfOperations_addEdge = numOfOperations * 0.25; 		// 20% for add edge
  	...
  	int numOfOperations_containsEdge = numOfOperations * 0.1; 	// 15% for contains edge
